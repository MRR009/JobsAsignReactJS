...
class AllJobsSection extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      activeSalaryRangeId: '',
      searchInput: '',
      isEmploymentFilterActive: false,
  ...
  getJobs = async () => {
    ...
    const jobsApiUrl = `https://apis.ccbp.in/jobs?employment_type=${activeEmploymentTypeId}&minimum_package=${activeSalaryRangeId}&search=${searchInput}`
    const options = {
      headers: {
